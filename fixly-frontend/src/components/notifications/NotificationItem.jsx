...
const ICON_MAP = {
  BOOKING: { icon: FaCalendarAlt, cls: "fnotif-icon-booking" },
  REVIEW: { icon: FaStar, cls: "fnotif-icon-review" },
  PROVIDER: { icon: FaTools, cls: "fnotif-icon-provider" },
  APPROVAL: { icon: FaCheckCircle, cls: "fnotif-icon-approval" },
  REJECTION: { icon: FaTimesCircle, cls: "fnotif-icon-rejection" },
  SUSPENDED: { icon: FaBan, cls: "fnotif-icon-suspended" },
  COMPLETED: { icon: FaCheck, cls: "fnotif-icon-completed" },
  DEFAULT: { icon: FaBell, cls: "fnotif-icon-default" },
};
